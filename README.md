...
<summary> Microfoft azure  </summary>
    <ul>
    <li><a href="formulario-app2-c2drc0btgbg2a7cg.brazilsouth-01.azurewebsites.net">Azure</a></li>    
    </ul>
...
```sh
cd Forms-Linters
git https://github.com/AndresFelipe22/Forms-Linters.git
...
🧑🏻‍💻 **Author 1**
 ...
 - GitHub: [@AndresFelipe22](https://github.com/AndresFelipe22)
...
Feel free tp check the [issues page](https://github.com/AndresFelipe22/Forms-Linters/issues)
